...
// const imageUrls = [
//   "{% static 'assets/img/ART_1.jpg' %}",
//   "{% static 'assets/img/ART_2.jpg' %}",
//   "{% static 'assets/img/ART_3.jpg' %}",
//   "{% static 'assets/img/ART_4.jpg' %}",
//   "{% static 'assets/img/ART_5.jpg' %}",
//   "{% static 'assets/img/ART_6.jpg' %}",
//   "{% static 'assets/img/ART_7.jpg' %}",
//   "{% static 'assets/img/ART_8.jpg' %}",
//   "{% static 'assets/img/ART_9.jpg' %}",
//   "{% static 'assets/img/ART_10.jpg' %}",
//   "{% static 'assets/img/ART_11.jpg' %}",
//   "{% static 'assets/img/ART_12.jpg' %}",
//   "{% static 'assets/img/ART_13.jpg' %}",
//   "{% static 'assets/img/ART_14.jpg' %}",
//   "{% static 'assets/img/ART_15.jpg' %}",
//   "{% static 'assets/img/ART_16.jpg' %}",
//   "{% static 'assets/img/ART_17.jpg' %}"
// ];
